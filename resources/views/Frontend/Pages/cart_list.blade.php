...
@section('content')
    <div id="all" style="margin-top: 100px">
                            ...
                            <form method="get" action="shop-checkout1.html">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><a href="#"><img src="images/cart_1.jpg" alt="White Blouse Armani" class="img-fluid"></a></td>
                                        ...
                                        <tr>
                                            <td><a href="#"><img src="images/cart_2.jpg" alt="Black Blouse Armani" class="img-fluid"></a></td>
